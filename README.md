...
Currently we have:
 ...
 - **n-Body**: a [N-Body](https://en.wikipedia.org/wiki/N-body_simulation) simulation written in C++ and animation done in Python. The animation generated shows the evolution of the Solar System from some day in Sep. 1994 for approximately 500 years into the future. Also, a short analysis on the implemented ODE solvers is present.
