...
### Goals of this project:
 - get familiar with `boost/odeint`, professional ODE solver. For this, implement some simple ODE solvers (Explicit Euler, Explicit Midpoint, Velocity Verlet), and compare it to them.
...
### Currently working on:
 ...
 - Currently the data generated by `main.cpp` is saved in a `.txt`-file. This seems suboptimal... Since Python has a really nice HDF5-library, I'm trying to produce a `.hdf5`-file in C++ with the data.
