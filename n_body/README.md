...
### Currently working on:
 ...
 - Currently the data generated by `main.cpp` is saved in a `.txt`-file. This seems suboptimal... Since Python has a really nice HDF5-library, I'm trying to produce one in C++ with the data.
